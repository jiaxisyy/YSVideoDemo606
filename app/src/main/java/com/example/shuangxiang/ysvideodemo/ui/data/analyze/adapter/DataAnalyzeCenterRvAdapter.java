package com.example.shuangxiang.ysvideodemo.ui.data.analyze.adapter;
...
public class DataAnalyzeCenterRvAdapter extends RecyclerView.Adapter {
    ...
    public DataAnalyzeCenterRvAdapter(Context context, List<String> names) {
        mContext = context;
        this.names = names;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (names != null && names.size() > 0) {
            ...
            viewHolder.mTitle.setTextColor(Color.parseColor("#c7edf9"));
            int i = new Random().nextInt(4);
            switch (i) {
                case 0:
                    viewHolder.mPic.setImageResource(R.drawable.icon_yali);
                    break;
                case 1:
                    viewHolder.mPic.setImageResource(R.drawable.icon_wendu);
                    break;
                case 2:
                    viewHolder.mPic.setImageResource(R.drawable.icon_fuhe);
                    break;
                case 3:
                    viewHolder.mPic.setImageResource(R.drawable.icon_jienengliang);
                    break;
            }
