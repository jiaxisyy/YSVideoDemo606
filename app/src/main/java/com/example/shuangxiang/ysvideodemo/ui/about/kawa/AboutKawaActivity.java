...
public class AboutKawaActivity extends BaseActivity {
    @BindView(R.id.tb_aboutKawa)
    Toolbar mTbAboutKawa;

    @Override
    protected void initContentView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_about_kawa);
